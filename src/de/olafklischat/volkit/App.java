...
public class App {
    ...
    private class MainFrameCanvas extends AWTGLCanvas {
        ...
        public MainFrameCanvas() throws LWJGLException {
            super();
            this.addMouseListener(awtMouseForwarder);
            this.addMouseMotionListener(awtMouseForwarder);
            this.addMouseWheelListener(awtMouseForwarder);
        }
        
        protected MouseAdapter awtMouseForwarder = new MouseAdapter() {
            ...
            public void mouseDragged(MouseEvent e) {
                gui.handleMouse(e.getX(), e.getY(), -1, false);
            ...
            public void mousePressed(MouseEvent e) {
                gui.handleMouse(e.getX(), e.getY(), mouseButtonAwtToTwl(e.getButton()), true);
                MainFrameCanvas.this.repaint();
            }

            @Override
            public void mouseReleased(MouseEvent e) {
                gui.handleMouse(e.getX(), e.getY(), mouseButtonAwtToTwl(e.getButton()), false);
                MainFrameCanvas.this.repaint();
            }

            @Override
            public void mouseWheelMoved(MouseWheelEvent e) {
                gui.handleMouseWheel(e.getWheelRotation() < 0 ? -10 : 10);
                MainFrameCanvas.this.repaint();
            }

            // not overridden / generated by TWL internally: mouseClicked, mouseEntered, mouseExited
        };
